 ...
 */
export const addAction = (hookName: string, callback: (...args: any) => void, priority = 10) =>
{
 ...
 */
export const addFilter = <T> (hookName: string, callback: (value?: T, ...args: any) => T, priority = 10) =>
{
